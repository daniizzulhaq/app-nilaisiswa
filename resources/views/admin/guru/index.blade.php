...
<style>
    ...
    .btn-view { background: rgba(16,185,129,.12); color: #10b981; }
    .btn-view:hover { background: rgba(16,185,129,.25); }
    ...
    .guru-nip  { font-size: 11.5px; color: var(--muted); font-family: 'JetBrains Mono', monospace; }
...
<div class="page-header">
    <div class="page-header-left">
        <h2>Data Guru</h2>
        <p>Total {{ $guru->total() }} guru terdaftar</p>
    </div>
...
{{-- TOOLBAR --}}
<form method="GET" action="{{ route('admin.guru.index') }}" class="toolbar">
    <div class="search-box">
        <i class="fas fa-magnifying-glass"></i>
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari nama atau NIP...">
    </div>
    @if(request()->hasAny(['q']))
        <a href="{{ route('admin.guru.index') }}" class="btn btn-cancel btn-sm">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge-email" title="{{ $g->user->email ?? '-' }}">
                ...
                <td>
                    <div class="actions">
                        <a href="{{ route('admin.guru.show', $g) }}" class="btn btn-view btn-sm">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{ route('admin.guru.edit', $g) }}" class="btn btn-edit btn-sm">
                            <i class="fas fa-pen"></i> Edit
                        </a>
                        <button type="button" class="btn btn-delete btn-sm"
                            onclick="confirmDelete({{ $g->id }}, '{{ addslashes($g->nama) }}')">
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box">
        <h3>🗑️ Hapus Guru</h3>
        <p>Apakah kamu yakin ingin menghapus <strong id="deleteGuruName"></strong>?
...
// Auto-submit search on enter / debounce
