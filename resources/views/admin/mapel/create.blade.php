...
@section('breadcrumb')
    <span>Admin</span> / <a href="{{ route('admin.mapel.index') }}">Data Mata Pelajaran</a> / Tambah
@endsection
...
<div class="form-header">
    <div class="form-header-left">
        ...
        <p>Isi form di bawah untuk menambahkan mata pelajaran baru</p>
    </div>
    ...
    <form action="{{ route('admin.mapel.store') }}" method="POST">
        ...
        <div class="form-body">
            ...
            <div class="preview-box">
                ...
                <div class="preview-info">
                    <div class="preview-name" id="previewName">Nama Mata Pelajaran</div>
                    <div class="preview-sub"  id="previewKode">Kode Mapel</div>
                </div>
            </div>
        ...
        <div class="form-footer">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-floppy-disk"></i> Simpan Mapel
            </button>
        </div>
    </form>
</div>
...
<script>
    ...
    // Init if old value exists (validation error)
    updatePreview();
</script>
@endpush